...
@section('content')
    ...
    <div class="border-gray-600 bg-white rounded m-4 p-4">
        <section class="flex w-full">
            <section id="header" class="flex w-full font-bold">
                <article class="w-10/12 px-2 py-1"><h2 class="text-2xl font-bold">Page {{ ucwords(__($page->title)) }} Posts</h2></article>
    ...
    <livewire:admin.post.index :parent="$page"></livewire:admin.post.index>
@endsection
