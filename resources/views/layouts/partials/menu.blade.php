<nav class="fixed top-0 left-0 bottom-0 w-64 bg-green-900 text-white flex flex-col justify-between">
    <ul>
        <li class="text-2xl font-bold text-center border-b-2 border-white mt-4">BridgeCMS</li>
        @can('access-admin')
            <x-menu.item route="" title="Admin Panel" class="mt-4 border-t-2 border-b-2 border-green-700"></x-menu.item>
        @endcan
